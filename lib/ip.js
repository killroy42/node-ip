...
ip.isPrivate = function isPrivate(addr) {
  return addr.match(/^(::ffff:)?10\.([0-9]{1,3})\.([0-9]{1,3})\.([0-9]{1,3})/) != null ||
    addr.match(/^(::ffff:)?192\.168\.([0-9]{1,3})\.([0-9]{1,3})/) != null ||
    addr.match(/^(::ffff:)?172\.(1[6-9]|2\d|30|31)\.([0-9]{1,3})\.([0-9]{1,3})/) != null ||
    addr.match(/^(::ffff:)?127\.([0-9]{1,3})\.([0-9]{1,3})\.([0-9]{1,3})/) != null ||
    addr.match(/^(::ffff:)?169\.254\.([0-9]{1,3})\.([0-9]{1,3})/) != null ||
